...
// Panel que muestra la interfaz de combate, incluyendo el orden de turno, los combatientes y los botones de acción.
...
public final class CombatPanel extends BackgroundPanel {
    ...
    private final TurnOrderPanel turnOrderPanel = new TurnOrderPanel();
    ...
    public CombatPanel() {
        ...
        topContainer.add(turnOrderPanel, BorderLayout.NORTH);
        ...
        javax.swing.JSplitPane southSplit = new javax.swing.JSplitPane(javax.swing.JSplitPane.HORIZONTAL_SPLIT, bottom, null);
