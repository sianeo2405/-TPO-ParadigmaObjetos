...
public final class PartyPanel extends JPanel {
    ...
    private final JLabel goldLabel = new JLabel("Oro disponible: 0 🪙", SwingConstants.CENTER);
    ...
    public PartyPanel() {
        ...
        goldLabel.setForeground(new Color(218, 165, 32)); // Goldenrod color
    ...
    private static final class HeroCard extends JPanel {
        ...
        void refresh(PartyMember member, boolean isActive) {
            ...
            if (isActive) {
                setBackground(new Color(255, 223, 128)); // Soft Gold background
            } else {
