...
public class Wolf extends Enemy {
    public Wolf(String name, int maxHp, int attack, int defense, int speed, int goldReward, int xpReward) {
    ...
    public void executeTurn(CombatEngine engine, Party party) {
        ...
        // Inflige sangrado por 5% de maxHp por turno
        target.applyBleed(3, 0.05);
    }
}
